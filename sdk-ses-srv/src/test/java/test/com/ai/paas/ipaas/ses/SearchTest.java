...
public class SearchTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        AuthDescriptor ad = new AuthDescriptor(authAddr, authPid, authPasswd, srvId);
    ...
    public void setUp() throws Exception {
        ...
        String mapping = "{" + "   \"" + indexName + "\" : {" + "     \"properties\" : {"
        ...
        client.addMapping(indexName, mapping, "userId");
    }
    ...
    public void testBulkDelete() {
        ...
        ids.add("106");
        ids.add("107");
        assertTrue(client.bulkDelete(ids) >= 1);
    }
    ...
    public void testDeleteListOfSearchCriteria() {
        ...
        assertTrue(client.delete(searchCriterias) >= 1);
    }
    ...
    public void testBulkMapUpdate() {
        ...
        data.add(data2);
        data.add(data3);
        assertTrue(client.bulkMapUpdate(ids, data) >= 1);
    }
    ...
    public void testBulkJsonUpdate() {
        ...
        datas.add(data2);
        datas.add(data3);
        assertTrue(client.bulkJsonUpdate(ids, datas) >= 1);
    }
    ...
    public void testBulkUpdateListOfStringListOfT() {
        ...
        ids.add("106");
        ids.add("107");
        assertTrue(client.bulkUpdate(ids, datas) >= 1);
    }
    ...
    public void getSuggestStringString() {
        String mapping = "{" + "   \"" + indexName + "\" : {" + "  \"_all\": {" + "\"analyzer\": \"nGram_analyzer\","
    ...
    public void testAddMapping() {
        ...
        String mapping = "{" + "   \"userInfo\" : {" + "     \"properties\" : {"
                + "     	\"userId\" :  {\"type\" : \"string\", \"store\" : \"yes\",\"index\": \"not_analyzed\"},"
