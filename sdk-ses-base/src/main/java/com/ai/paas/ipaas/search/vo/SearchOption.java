...
public class SearchOption implements Serializable {
    ...
    public enum TermOperator {
        ...
        public static TermOperator fromValue(int typeCode) {
            ...
            throw new IllegalArgumentException("Invalid search status type code: " + typeCode);
    ...
    public static String formatDate(String dtFmt, Object object) {
        if (object instanceof java.util.Date) {
            return SearchOption.formatDateFromDate(dtFmt, (java.util.Date) object);
        }
        return SearchOption.formatDateFromString(dtFmt, object.toString());
    }
    ...
    public static String formatDateFromDate(String dtFmt, Date date) {
        if (null == date)
            return null;
        if (null != dtFmt) {
            SimpleDateFormat gmt = new SimpleDateFormat(dtFmt);
            return gmt.format(date);
        }
        SimpleDateFormat hmsFmt = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZZZ");
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        try {
            return hmsFmt.format(date);
        } catch (Exception e) {
        }
        try {
        ...
        return hmsFmt.format(new Date());
    }

    public static String formatDateFromString(String dtFmt, String date) {
        if (null == date)
            return null;
        if (null != dtFmt) {
            SimpleDateFormat gmt = new SimpleDateFormat(dtFmt);
