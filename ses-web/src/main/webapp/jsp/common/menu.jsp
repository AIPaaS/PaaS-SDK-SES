...
<div class="ui navbar ng-scope">
	<ul class="nav nav-pills nav-stacked">
		...
		<li class="logo logoa"><a href="${ctx}/dataimport/toOne"  id="toOneNav" data-toggle="tooltip" data-placement="right" title="数据导入-单库"><i class="icon-home"></i></a></li>
		<li class="logo logoa"><a href="${ctx}/dataimport/toMany"  id="toManyNav" data-toggle="tooltip" data-placement="right" title="数据导入-多库"><i class="icon-sitemap"></i></a></li>
